...
save_rds <- function(x, name) {
  ...
  file <- file.path(getOption("ranmr.dir", "results"), "rds", paste0(name, ".rds"))
...
#' Create Directories
#'
#' Creates directory getOption("ranmr.dir") with the
#' subdirectories plots, rds and pdf to save plots and results.
#'
#' @export
create_dirs <- function () {
  dir.create(file.path(getOption("ranmr.dir", "results") ,"plots"), showWarnings = FALSE, recursive = TRUE)
  dir.create(file.path(getOption("ranmr.dir", "results") ,"pdfs"), showWarnings = FALSE, recursive = TRUE)
  dir.create(file.path(getOption("ranmr.dir", "results") ,"rds"), showWarnings = FALSE, recursive = TRUE)
  invisible()
}
...
replicate_results <- function(mode = "debug", parallel = FALSE, base_family = "", dir = getOption("ranmr.dir", "results")) {
  ...
  od <- getOption("ranmr.dir", "results")
